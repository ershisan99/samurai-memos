    ...
    return (
        <div className='drawer drawer-mobile bg-base-100'>
            ...
            <div className='drawer-content flex flex-col'>
                <nav
                    className='navbar sticky top-0 z-30 h-16 w-full bg-opacity-90 backdrop-blur transition-all duration-100 bg-base-100 text-base-content'>
            ...
            <div className='drawer-side'>
                ...
                <aside className='bg-base-200 w-80'>
                    <div
                        className='flex z-20 bg-base-200 bg-opacity-90 backdrop-blur sticky top-0 items-center gap-2 px-4 py-2'>
                        <Link href={'/'}>
